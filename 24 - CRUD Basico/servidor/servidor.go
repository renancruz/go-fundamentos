...
// CriaUsuario insere um usuário no banco de dados
func CriarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if erro != nil {
		w.Write([]byte("Erro ao retornar ultimo id inserido!"))
	}
...
func BuscarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if linha.Next() {
		if erro := linha.Scan(&usuario.ID, &usuario.Nome, &usuario.Email); erro != nil {
			w.Write([]byte("Erro ao escaniar usuário!"))
			return
		}
	}
...
func AtualizarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if erro != nil {
		w.Write([]byte("Erro ao convertero parâmetro para inteiro!"))
		return
	}
